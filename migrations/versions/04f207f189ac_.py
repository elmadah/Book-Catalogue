...
Revision ID: 04f207f189ac
Revises: 1cdadcbf51fc
Create Date: 2017-11-02 23:15:22.472812
...
revision = '04f207f189ac'
down_revision = '1cdadcbf51fc'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('averageRatingB', sa.String(length=13), nullable=True),
