...
Revision ID: 6bbbc125c880
Revises: 04f207f189ac
Create Date: 2017-11-02 23:18:28.616368
...
revision = '6bbbc125c880'
down_revision = '04f207f189ac'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('averageRatingB', sa.INTEGER(), nullable=True),
